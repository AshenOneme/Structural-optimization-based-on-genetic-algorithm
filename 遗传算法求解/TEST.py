...
for i in range(7):
    ops.element('elasticBeamColumn',201+4*i,83+2*i,4+2*i,5341, 206000e5, 0.79e5, 38720129,19360065,19360065, IDRTransf)
    ops.element('elasticBeamColumn',202+4*i,83+2*i,28+2*i,5341, 206000e5, 0.79e5, 38720129,19360065,19360065, IDRTransf)
    ops.element('elasticBeamColumn',203+4*i,84+2*i,45+2*i,5341, 206000e5, 0.79e5, 38720129,19360065,19360065, IDRTransf)
    ops.element('elasticBeamColumn',204+4*i,84+2*i,68+2*i,5341, 206000e5, 0.79e5, 38720129,19360065,19360065, IDRTransf)
...
print("****************************************","Bears","****************************************")
ops.element('twoNodeLink',401,101,1,'-mat',IDBearingZ,IDBearingXY,IDBearingXY,'-dir',1,2,3,'-orient',0,0,1,1,0,0)
ops.element('twoNodeLink',402,125,25,'-mat',IDBearingZ,IDBearingXY,IDBearingXY,'-dir',1,2,3,'-orient',0,0,1,1,0,0)
ops.element('twoNodeLink',403,143,43,'-mat',IDBearingZ,IDBearingXY,IDBearingXY,'-dir',1,2,3,'-orient',0,0,1,1,0,0)
ops.element('twoNodeLink',404,166,66,'-mat',IDBearingZ,IDBearingXY,IDBearingXY,'-dir',1,2,3,'-orient',0,0,1,1,0,0)
...
ops.wipeAnalysis()
ops.timeSeries('Path', 22, '-dt', 0.01, '-filePath','Load.txt', '-factor',2.5)
